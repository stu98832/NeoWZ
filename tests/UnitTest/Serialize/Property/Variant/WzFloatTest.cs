...
{
    [TestClass]
    public class WzFloatTest
    {
        private WzVariant Variant = new WzFloat("variant", 128.46f);
        private WzVariant Variant2 = new WzFloat("variant2", 0.0f);
        ...
        [TestMethod]
        public void ToDoubleTest() => Assert.AreEqual((double)128.46f, Variant.ToDouble(789.1));
        ...
        [TestMethod]
        public void EqualsTest() => Assert.AreEqual(new WzFloat("variant", 128.46f), Variant);

        [TestMethod]
        public void EqualsFailedTest() => Assert.AreNotEqual(new WzFloat("variant"), Variant);
    }
}
